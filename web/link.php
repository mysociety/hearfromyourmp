...
//
// $Id: link.php,v 1.7 2007-12-14 16:22:28 matthew Exp $
...
<form style="text-align: left; position: relative; background-color: #d9ecff;
    ...
    <p style="padding: 0.5em 0.5em 0.5em 0.5em; margin: 0 0 0 0;">
        <a href="http://' . $_SERVER['HTTP_HOST'] . '/" style="color: #20005C; 
        ...
        <a href="http://' . $_SERVER['HTTP_HOST'] . '/about" style="color: #20005C; font-weight:bold">
        Tell me more</a>
    </p>
</form>
';
